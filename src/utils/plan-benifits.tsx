...
import { MdOutlineMobileFriendly, MdOutlineHealthAndSafety } from "react-icons/md";
import { FaUserShield, FaRegHospital } from "react-icons/fa";
import { BsQrCodeScan } from "react-icons/bs";
import { HiOutlineUserPlus } from "react-icons/hi2";
import { IoPersonAddOutline } from "react-icons/io5";
import { CiDumbbell, CiDiscount1 } from "react-icons/ci";
...
export const goldPlanGrid = [
    ...
    { iconSrc: Tax, description: "Critical Insurance (CI) cover ₹2,50,000", icon: true, iconName: MdOutlineHealthAndSafety },
    ...
    { iconSrc: Tax, description: "Exclusive discounts on Diagnostic and Pharmacy.", icon: true, iconName: CiDiscount1 },
    { iconSrc: Tax, description: "Comprehensive Family Protection: (Include- Self, spouse, 2 children)", icon: true, iconName: GoPeople },
...
export const platinumPlanGrid = [
    ...
    { iconSrc: Tax, description: "Super Top-Up Cover (₹15 Lacs/₹25 Lacs)", icon: true, iconName: HiOutlineUserPlus },
    { iconSrc: Tax, description: "Exclusive discounts on Diagnostic and Pharmacy.", icon: true, iconName: CiDiscount1 },
    { iconSrc: Tax, description: "Comprehensive Family Protection: (Include- Self, spouse, 2 children)", icon: true, iconName: GoPeople },
