                ...
                <div>
                    <div className="flex flex-col md:flex-row gap-4 md:gap-9">
                        ...
                        <div className='flex flex-col gap-3'>
                            ...
                            <p className="text-black font-light md:leading-9">Streamlining your</p>

                            <p className="text-black text-2xl md:text-3xl font-bold md:leading-1">Health Management Through CarePass!</p>
